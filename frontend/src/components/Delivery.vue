...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="OrdermanagementId" v-model="value.ordermanagementId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            OrdermanagementId :  {{value.ordermanagementId }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="DeliverryStatus" v-model="value.deliverryStatus"/>
          </div>
          <div class="grey--text ml-4" v-else>
            DeliverryStatus :  {{value.deliverryStatus }}
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="OrdermanagementStatus" v-model="value.ordermanagementStatus"/>
          </div>
          <div class="grey--text ml-4" v-else>
            OrdermanagementStatus :  {{value.ordermanagementStatus }}
          </div>
